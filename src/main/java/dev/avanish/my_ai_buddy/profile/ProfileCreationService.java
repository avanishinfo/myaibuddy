...
import static dev.avanish.my_ai_buddy.profile.Utils.generateMyersBriggsTypes;
import static dev.avanish.my_ai_buddy.profile.Utils.selfieTypes;
...
public class ProfileCreationService {
    ...
    @Value("${myaibuddy.lookingForGender}")
    ...
    private void saveProfilesToJson(List<Profile> generatedProfiles) {
        try {
            ...
            for (Profile profile : generatedProfiles) {
                if (profile.imageUrl() == null || "".equals(profile.imageUrl()) || profile.imageUrl().startsWith("https://example.com")) {
